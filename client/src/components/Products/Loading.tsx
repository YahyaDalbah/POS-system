...
export default function Loading() {
  return (
    <div
      role="status"
      className="max-w-sm p-4 border border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-500 h-min"
    >
      <div className="flex items-center justify-center mb-4 bg-gray-300 rounded dark:bg-gray-500">
        <svg
